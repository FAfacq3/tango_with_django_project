...
urlpatterns = [
    ...
    path('category/<category_slug>/add_page/', views.add_page, name='add_page'),
    ...
    path('category/<slug:category_slug>/update_views/', views.update_category_views, name='update_category_views'),
